...
class DTCAModel(nn.Module):
    ...
    def forward(self,
        ...
        # word patch align [bsz, 60-len-197 , 768],[bsz, 197, 768]
        ...
        # image_pad = to rch.zeros(batch_size, image_len,dtype=torch.bool, device=attention_mask.device)
        ...
        #
        # loss =  cross_crf_loss + self.alpha * text_loss
        # loss =  cross_crf_loss
        # loss = text_loss
